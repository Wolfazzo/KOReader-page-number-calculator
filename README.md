...
-Open a book and note the page value indicated by Koreader

-Note the number of pages in the book’s print edition by checking in the relevant stores

-Open the mini-app and enter the two values. The app will calculate the number of characters per page to enter into Koreader instead of the default 1,500.

-If it’s not accurate, enter the new page count shown by Koreader in the “Final refinement” section of the mini-app and press “re-calculate.” It’s not perfect, you might end up with a difference of 1–3 pages, but it’s good enough. 
